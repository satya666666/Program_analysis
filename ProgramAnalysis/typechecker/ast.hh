...
class LessThenExpression : public BinaryExpression{
    public: LessThenExpression(Expression *l, Expression *r);
};
class MoreThenExpression : public BinaryExpression{
    public: MoreThenExpression(Expression *l, Expression *r);
};
...
class FunctionDefinitionList {
    private:
        vector<FunctionDefinition *> functionDefinitions;   // stores a complete list of functions in theprogram
    public:
