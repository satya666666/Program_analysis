...
LessThenExpression::LessThenExpression(Expression *l,Expression *r):BinaryExpression(l, r) {}
MoreThenExpression::MoreThenExpression(Expression *l,Expression *r):BinaryExpression(l, r) {}
EqualExpression::EqualExpression(Expression *l,Expression *r):BinaryExpression(l, r) {}
